      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              child: Image.network(
                'https://health.clevelandclinic.org/wp-content/uploads/sites/3/2018/06/weight-loss-battle-1.jpg',
                fit: BoxFit.cover,
              ),
              height: 100,
              width: 240,
    ...
    return Stack(
      ...
      children: <Widget>[
        ClipPath(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: Color.fromARGB(255, 115, 184, 193),
            ),
        ...
        Positioned(
          ...
          child: Container(
            decoration: BoxDecoration(
                color: Color.fromARGB(255, 28, 172, 191),
          ...
          child: Card(
            ...
            child: Column(
              children: <Widget>[
                Padding(
                  padding:
                      const EdgeInsets.only(top: 14.6, left: 40, right: 40),
                  child: Column(
                    children: <Widget>[
                      Text(
                        "TODAY'S GOAL",
